public class Arrays {
    public static void main(String[] args) {
        ...
        /* int[][] nums is java type array declaration
          whereas int nums[][] is C style array declaration */
        ...
        /* here below we are using for loop to fill random values in the array using a math function in java which gives random number
         between 0 and 1 and hence we have multiplied with 100 to give a two digit integer */
...
System.out.println();
        ...
        for(int[] n : nums){ //an array is taken from nums at a time and stored it into a different array n
            ...
            //For each loop:-
            //this loop just iterates between the different elements inside array

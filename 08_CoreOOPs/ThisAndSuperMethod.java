...
public class ThisAndSuperMethod {
    public static void main(String[] args) {
        ...
        /* the super method in every constructor calls the super class, as obj for b is created and then our compiler enters
        ...
        the answer is that every class in java extends to "Object" class so even A extends to nothing as we can see, there is a hidden line
        that says "A extends Object" */
